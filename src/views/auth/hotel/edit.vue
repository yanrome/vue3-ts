    ...
    <a-form ref="formRef"
      ...
      <a-form-item label="酒店名称"
        ...
        <a-input style="width: 300px"
                 v-model:value="hotelMassage.hotelName"
                 placeholder="请输入酒店名称" />
      </a-form-item>
      <a-form-item label="电话"
                   name="phone">
        <a-input style="width: 300px"
                 v-model:value="hotelMassage.phone"
                 placeholder="请输入联系电话" />
      </a-form-item>
      <a-form-item label="酒店地址">
        <a-space>
          <a-cascader style="width: 300px"
                      v-model:value="pcaList"
                      :fieldNames="{ label: 'name', value: 'name', children: 'children' }"
                      placeholder="请选择省市区"
                      :options="options"></a-cascader>
          <a-input style="width: 300px"
                   v-model:value="hotelMassage.location"
                   placeholder="请输入详细地址" />
        </a-space>
        ...
        <a-form :labelAlign="'left'"
          ...
          <a-form-item label="经度">
            <a-input style="width: 150px"
                     v-model:value="hotelMassage.longitude"
                     placeholder="请输入经度" />
          </a-form-item>
          <a-form-item label="纬度">
            <a-input style="width: 150px"
                     v-model:value="hotelMassage.latitude"
                     placeholder="请输入纬度" />
          </a-form-item>
      ...
      <a-form-item label="开业时间">
        <a-date-picker v-model:value="hotelMassage.opening"
                       placeholder="选择开业时间"></a-date-picker>
      </a-form-item>
      <a-form-item label="装修时间">
        <a-date-picker v-model:value="hotelMassage.decoration"
                       placeholder="选择开业时间"></a-date-picker>
      </a-form-item>
      <a-form-item label="酒店介绍">
        <a-textarea style="width: 650px"
      ...
      <a-form-item label="入离时间">
        <div>
          <a-time-picker v-model:value="roomTime"
                         format="HH:mm" />后办理入住，
          离店请于
          <a-time-picker v-model:value="leaveTime"
                         format="HH:mm" />前办理退房
        </div>
      </a-form-item>
      <a-form-item label="订单取消时间">
        <a-time-picker v-model:value="cancelTime"
                       format="HH:mm" />
      </a-form-item>
