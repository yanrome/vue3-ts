<template>
    <div class="tabs-view">
        ...
        <!--            class="tabs">-->
        <!--&lt;!&ndash;      <template v-for="(pageItem, index) in tabsList" :key="pageItem.fullPath">&ndash;&gt;-->
        <!--&lt;!&ndash;        <a-tab-pane>&ndash;&gt;-->
        <!--&lt;!&ndash;          <template #tab>&ndash;&gt;-->
        <!--&lt;!&ndash;            <a-dropdown :trigger="['contextmenu']">&ndash;&gt;-->
        <!--&lt;!&ndash;              <div style="display: inline-block">&ndash;&gt;-->
        <!--&lt;!&ndash;                {{ pageItem.meta.title }}&ndash;&gt;-->
        <!--&lt;!&ndash;              </div>&ndash;&gt;-->
        <!--&lt;!&ndash;              <template v-slot:overlay>&ndash;&gt;-->
        <!--&lt;!&ndash;                <a-menu style="user-select: none">&ndash;&gt;-->
        <!--&lt;!&ndash;                  <a-menu-item @click="reloadPage" :disabled="activeKey !== pageItem.fullPath" key="1">&ndash;&gt;-->
        <!--&lt;!&ndash;                    <reload-outlined/>&ndash;&gt;-->
        <!--&lt;!&ndash;                    刷新&ndash;&gt;-->
        <!--&lt;!&ndash;                  </a-menu-item>&ndash;&gt;-->
        <!--&lt;!&ndash;                  <a-menu-item @click="removeTab(pageItem)" key="2">&ndash;&gt;-->
        <!--&lt;!&ndash;                    <close-outlined/>&ndash;&gt;-->
        <!--&lt;!&ndash;                    关闭&ndash;&gt;-->
        <!--&lt;!&ndash;                  </a-menu-item>&ndash;&gt;-->
        <!--&lt;!&ndash;                  <a-menu-divider/>&ndash;&gt;-->
        <!--&lt;!&ndash;                  <a-menu-item @click="closeLeft(pageItem, index)" key="3">&ndash;&gt;-->
        <!--&lt;!&ndash;                    <vertical-right-outlined/>&ndash;&gt;-->
        <!--&lt;!&ndash;                    关闭左侧&ndash;&gt;-->
        <!--&lt;!&ndash;                  </a-menu-item>&ndash;&gt;-->
        <!--&lt;!&ndash;                  <a-menu-item @click="closeRight(pageItem, index)" key="4">&ndash;&gt;-->
        <!--&lt;!&ndash;                    <vertical-left-outlined/>&ndash;&gt;-->
        <!--&lt;!&ndash;                    关闭右侧&ndash;&gt;-->
        <!--&lt;!&ndash;                  </a-menu-item>&ndash;&gt;-->
        <!--&lt;!&ndash;                  <a-menu-divider/>&ndash;&gt;-->
        <!--&lt;!&ndash;                  <a-menu-item @click="closeOther(pageItem)" key="5">&ndash;&gt;-->
        ...
        <!--&lt;!&ndash;            &lt;!&ndash;          <span @contextmenu="rightClick" style="display: inline-block" :pagekey="pageItem.fullPath">{{pageItem.meta.title}}</span>&ndash;&gt;&ndash;&gt;-->
        <!--&lt;!&ndash;          </template>&ndash;&gt;-->
        <!--&lt;!&ndash;        </a-tab-pane>&ndash;&gt;-->
        <!--&lt;!&ndash;      </template>&ndash;&gt;-->
